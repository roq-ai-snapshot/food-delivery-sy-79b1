...
export namespace Prisma {
  ...
  */
  ...
  interface delivery_driverFieldRefs {
    ...
    readonly availability: FieldRef<'delivery_driver', 'String'>;
  ...
  export type delivery_driverWhereInput = {
    ...
    availability?: StringFilter<'delivery_driver'> | string;
  ...
  export type delivery_driverScalarWhereWithAggregatesInput = {
    ...
    availability?: StringWithAggregatesFilter<'delivery_driver'> | string;

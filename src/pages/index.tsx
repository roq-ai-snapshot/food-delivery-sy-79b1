  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Food Delivery System - Your one-stop solution for all pick-up, delivery and dine-in orders. Streamlining your food ordering experience online."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1481671703460-040cb8a2d909?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMkJmb29kJTJCb3JkZXJpbmd8ZW58MHx8fHwxNjk4MzEwMDI2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Food Delivery System - Your one-stop solution for all pick-up, delivery and dine-in orders. Streamlining your food ordering experience online.`}
            </Text>
            <Box

...
import { useRoqPlatformUserProfiles, useDeliveryDriverCount, useOrderItemCount, useOrderCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const deliveryDriverStat = useDeliveryDriverCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: deliveryDriverStat?.data,
      isLoading: deliveryDriverStat.isLoading,
